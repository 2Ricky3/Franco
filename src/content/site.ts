export const site = {
  ...
  accommodation: {
    ...
    listings: [
      {
        id: "cheerio-gardens",
        name: "Cheerio Gardens & Afri Camps",
        note: "3.6 km from Minas. Eight cottages & ten tents. Sleeps up to 80.",
        photo: "/photos/stay-cheerio-gardens.jpg",
        links: [
          { label: "Book cottages", url: "https://www.cheerio.co.za/" },
          {
            label: "Book Afri Camps",
      ...
      {
        id: "stanford",
        name: "Stanford Lake Lodge",
        note: "7 km from Minas. Four cottages. Sleeps up to 22.",
        photo: "/photos/stay-stanford.jpg",
        links: [{ label: "Book Stanford", url: "http://www.stanfordlake.co.za/" }],
      },
      {
        id: "mountain-fly-fishing",
        name: "Mountain Fly Fishing",
        note: "8.3 km from Minas. Eight cottages. Sleeps up to 40.",
        photo: "/photos/stay-mff.jpg",
        links: [
          { label: "Book MFF", url: "https://www.mountainflyfishing.co.za/" },
        ],
      },
      {
        id: "boscobel",
        name: "Boscobel Cottages",
        note: "6 km from Minas. Three cottages. Sleeps up to 12.",
        photo: "/photos/stay-boscobel.jpg",
        links: [
          { label: "Book Boscobel", url: "https://www.boscobelcottages.co.za/" },
        ],
      },
      {
        id: "viewpoint",
        name: "Viewpoint Estate",
        note: "10 km from Minas. Guesthouse & cabins. Sleeps up to 12.",
        photo: "/photos/stay-viewpoint.jpg",
        links: [
          { label: "Book Viewpoint", url: "https://www.viewpointestate.co.za/" },
        ],
      },
      {
        id: "bramasole",
        name: "Bramasole",
        note: "12 km from Minas. Guesthouse & chalets. Sleeps up to 36.",
        photo: "/photos/stay-bramasole.jpg",
        links: [{ label: "Book Bramasole", url: "https://www.bramasole.co.za/" }],
      },
      {
        id: "glenogle",
        name: "Glenogle",
        note: "10 km from Minas. Three units. Sleeps up to 5.",
        photo: "/photos/stay-glenogle.jpg",
        links: [{ label: "Book Glenogle", url: "https://www.glenogle.co.za/" }],
      },
      {
        id: "pavetta",
        name: "Pavetta Country House",
        note: "12 km from Minas. Country house. Sleeps up to 10.",
        photo: "/photos/stay-pavetta.jpg",
        links: [{ label: "Book Pavetta", url: "https://pavetta.co.za/" }],
      },
      {
        id: "diggers-rest",
        name: "Diggers Rest",
        note: "8.3 km from Minas. Eight cottages. Sleeps up to 40.",
        photo: "/photos/stay-diggers.jpg",
        links: [
          {
            label: "Book Diggers",
            url: "https://www.lekkeslaap.co.za/accommodation/diggersrest-lodge",
          },
        ],
      },
      {
        id: "art-gallery",
        name: "Art Gallery Guesthouse",
        note: "6 km from Minas. Four double rooms. Sleeps up to 8.",
        photo: "/photos/stay-art-gallery.jpg",
        links: [
          {
            label: "Book guesthouse",
            url: "https://www.lekkeslaap.co.za/accommodation/art-gallery-guest-house",
          },
        ],
      },
    ],
